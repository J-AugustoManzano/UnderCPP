...
using IteratorFruta = std::unordered_map<std::string, size_t>::const_iterator;
...
void adicionarFruta(std::unordered_map<std::string, size_t> &frutas) {
...
void removerFruta(std::unordered_map<std::string, size_t> &frutas) {
    std::string nome = entraFruta();
    std::unordered_map<std::string, size_t>::iterator it = frutas.find(nome);
...
void buscarFruta(const std::unordered_map<std::string, size_t> &frutas) {
    std::string nome = entraFruta();
...
void exibirInventario(const std::unordered_map<std::string, size_t> &frutas) {
...
int main(void) {
    std::unordered_map<std::string, size_t> frutas;
    int16_t opcao = 0;
